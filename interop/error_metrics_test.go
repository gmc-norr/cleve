...
func TestReadErrorMetrics(t *testing.T) {
	testcases := []struct {
	...
	}{
		{
			...
			path:        "./testdata/20250123_LH00352_0033_A225H35LT1/InterOp/ErrorMetricsOut.bin",
			shouldError: true,
		},
		{
			name:    "novaseq",
			path:    "./testdata/20250115_LH00352_0031_A225HMVLT1/InterOp/ErrorMetricsOut.bin",
			version: 6,
		},
		{
			name:    "nextseq",
			path:    "./testdata/250210_NB551119_0457_AHL3Y2AFX7/InterOp/ErrorMetricsOut.bin",
			version: 3,
		},
		{
			name:    "miseq",
			path:    "./testdata/250207_M00568_0665_000000000-LMWPP/InterOp/ErrorMetricsOut.bin",
			version: 3,
		},
		{
			name:    "miseq old",
			path:    "./testdata/160122_M00568_0146_000000000-ALYCY/InterOp/ErrorMetricsOut.bin",
			version: 3,
		},
	}
