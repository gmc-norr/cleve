...
import (
	"context"
	"fmt"
	"github.com/gmc-norr/cleve/internal/key"
	"go.mongodb.org/mongo-driver/bson"
	"go.mongodb.org/mongo-driver/mongo"
)

func AddKey(k *key.APIKey) error {
